...
Los resultados de aprendizaje (RA) del módulo profesional **Proyecto de Administración de Sistemas Informáticos en Red (0379)** establecen las capacidades que el alumnado debe demostrar al finalizar el proceso formativo.  
...
- Claridad, precisión y rigor técnico de la exposición.  
- Coherencia entre la propuesta inicial, el desarrollo y los resultados obtenidos.  
- Capacidad de argumentación, análisis crítico y justificación de las decisiones adoptadas.  
